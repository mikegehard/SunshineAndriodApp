    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                String cityState = params[0];
                int numberOfDays = 7;
                Uri.Builder uri = new Uri.Builder();

                uri.scheme("http://api.openweathermap.org");
                uri.path("/data/2.5/forecast/daily");
                uri.appendQueryParameter("q", cityState);
                uri.appendQueryParameter("mode", "json");
                uri.appendQueryParameter("units", "metric");
                uri.appendQueryParameter("cnt", String.valueOf(numberOfDays));
